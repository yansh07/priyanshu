...
const BlogPostCard: React.FC<BlogPostProps> = ({
  ...
  return (
    <motion.a
      ...
      whileHover="hover"
      className="bg-gradient-to-br from-gray-800/30 to-black/30 border border-gray-700/40 rounded-lg p-6 flex flex-col shadow-xl overflow-hidden cursor-pointer group backdrop-blur-md"
    >
...
const Blog: React.FC = () => {
  const blogPostsData: BlogPostProps[] = [
    {
      ...
      description:
        "You’re going to die. So what’s worth doing before you do? Most people plan their bucket list for ‘someday.’ What if death makes someday now?",
      link: "https://medium.com/@yansh08/how-to-use-death-to-design-a-life-worth-living-9bf212919f16",
    },
    {
      title:
        "The Burden of Awareness: Dostoevsky on Intelligence and Happiness",
      description:
        "Sometimes I think about how easily we used to be happy as children. But as our understanding and intelligence grew...",
  ...
  return (
    ...
    >
      ...
      {/* 🌈 Optional fade-to-dark transition */}
