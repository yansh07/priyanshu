...
const projects = [
  ...
  {
    icon: "/pk.webp",
    alt: "portfolio AI icon",
    title: "Portfolio Website",
    description: "Built a portfolio website using React, HTML, CSS and styled with Tailwind CSS. Deployed the website on Vercel and integrated a response form with the Formspree API. Achieved 90+ Lighthouse score for performance and accessibility.",
    tech: ["Python", "OpenAI", "Whisper", "Edge TTS", "Playwright"],
  ...
  },
  {
    ...
    description: "A simple and responsive weather application built with React + Vite + Tailwind CSS. Fetches live weather data using the OpenWeather API and displays temperature, conditions, and location details. 99% uptime on Vercel deployment. Serves 200+ daily users with real-time weather data.",
    tech: ["React.js", "Node.js", "Express.js", "TailwindCSS", "OpenWeatherMap API"],
...
function Projectsum() {
  return (
    <div className=" text-gray-300 p-4 sm:p-8 min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
