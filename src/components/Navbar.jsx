...
function Navbar() {
  return (
    <div className="sticky top-0 md:absolute md:pt-6 md:px-6 lg:pt-12 lg:px-12 xl:px-12 xl:pt-12">
      <nav className="border max-w-screen flex flex-wrap rounded-2xl p-2 bg-white/15 hover:shadow-blue-500 shadow backdrop-blur-3xl md:max-w-sm">
  ...
  bg-gradient-to-l from-[#adad03] via-[#362424] to-[#043492] brightness-125
