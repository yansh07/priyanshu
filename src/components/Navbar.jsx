      ...
      `}>
        ...
        <div className="flex items-center gap-3 group cursor-pointer">
          ...
          <span className="font-[satoshi] text-gray-200 font-semibold text-xl md:text-2xl xl:text-3xl tracking-tight group-hover:text-white transition-colors duration-300">
            ...
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.1s'}}>r</span>
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.2s'}}>i</span>
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.3s'}}>y</span>
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.4s'}}>a</span>
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.5s'}}>n</span>
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.6s'}}>s</span>
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.7s'}}>h</span>
            <span className="inline-block group-hover:animate-pulse" style={{animationDelay: '0.8s'}}>u</span>
          </span>
        </div>
