    ...
    <div className="min-h-screen flex items-center justify-center px-4 lg:px-0 py-36 md:py-40 pb-8 md:pb-14 max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              <span className="relative z-10">
                ...
                and
                <span className="text-purple-400 font-semibold hover:text-purple-300 transition-colors duration-300">
                  {" "}
                  consciousness
                </span>
                .
      ...
      "
                ...
                "
                  style={{
                    background:
                      "linear-gradient(45deg, rgba(59,130,246,0.5), rgba(147,51,234,0.5), rgba(59,130,246,0.5))",
