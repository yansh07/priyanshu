      ...
      <div className="px-2 md:px-52 lg:px-80 lg:ml-6 xl:px-96 xl:ml-40">
        <div className="flex gap-3 py-6 mt-auto">
          <a
            ...
            aria-label="GitHub"
          >
            <i className="text-4xl md:text-4xl lg:text-4xl text-white/80 hover:text-white fa-brands fa-github"></i>
          </a>
          <a
            ...
            aria-label="Email"
          >
            <i className="text-4xl md:text-4xl lg:text-4xl hover:text-white text-white/80 fa-solid fa-envelope"></i>
          </a>
          <a
          ...
          >
            <i
              className="text-4xl md:text-4xl lg:text-4xl hover:text-white text-white/80 fa-brands fa-twitter"
              aria-hidden="true"
            ></i>
          </a>
          ...
          >
            <i
              className="text-4xl md:text-4xl lg:text-4xl hover:text-white text-white/80 fa-brands fa-medium"
              aria-hidden="true"
            ></i>
          </a>
        </div>
