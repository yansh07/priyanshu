          ...
          <div className="relative inline-block mb-8">
            <div className="relative group">
              <Image
                ...
                width={256}
                height={256}
                className="w-48 h-48 md:w-64 md:h-64 object-top rounded-full object-cover mx-auto border-4 border-purple-500/30 transition-all duration-500 group-hover:border-purple-400/60 group-hover:scale-105"
                priority
              />
